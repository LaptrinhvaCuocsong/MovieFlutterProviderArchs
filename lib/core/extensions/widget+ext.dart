        ...
        builder: (context) {
          return CupertinoAlertDialog(
            ...
            actions: getCupertinoActions(
                context, dialogContent.buttons, dialogContent.buttonActions),
          );
        });
  }

  List<CupertinoDialogAction> getCupertinoActions(BuildContext dialogContext,
      List<String> buttons, List<Function> buttonActions) {
